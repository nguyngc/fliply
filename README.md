...
The complete API documentation for Fliply is generated using Maven and stored in the repository.

### Access the documentation

**In-project documentation (recommended for graders):**
- **Location:** [`docs/javadoc/index.html`](docs/javadoc/index.html)
- **How to access:** Open the file in a web browser. It displays a summary page with quick links to:
  - Full API (HTML) site pages
  - Package index
  - Project README and submission files

**Single-file submission option:**
- **Location:** [`target/fliply-javadoc.zip`](target/fliply-javadoc.zip)
- **Contents:** A complete archive of all JavaDoc HTML files, ready to extract and view offline

### View the full API

After opening `docs/javadoc/index.html`, click **"Full API (index.html)"** to browse the complete JavaDoc site. The site includes:
- Class and method documentation
- Package summaries
- Use relationships and dependency trees
- Search functionality

### Regenerate the documentation

To regenerate JavaDoc (e.g., after code changes):

```bash
mvn clean javadoc:javadoc
```

The generated HTML will be placed in `target/site/apidocs/`. To update the in-project snapshot, copy the contents back to `docs/javadoc/site/`:

```bash
# On Windows PowerShell
Copy-Item -Path "target/site/apidocs/*" -Destination "docs/javadoc/site" -Recurse -Force
```
...
| `docs/javadoc` | In-project JavaDoc API documentation (index.html, site/) |
...
| `target/fliply-javadoc.zip` | Zipped JavaDoc archive for submission |
