...
|--------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------|----------------|
| Ngoc Nguyen  | - Update product backlog<br/>- Add language Selection Feature, Dynamic UI update<br/>- Identify Translatable Elements and Localize UI (Welcome page, Flashcard Sets)<br/>- Update README.md<br/>- Prepare Sprint 5 Review Report. | 12                 | Submitted      |
| Thanh Nguyen | - Identify Translatable Elements and Localize UI (Login, Account management, Classes management)<br/>- Prepare Sprint 6 Planning Report                                                                                           | 7                  | Submitted      |
